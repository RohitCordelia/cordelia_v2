...
import { buildCabinSelectPageContext } from '../../components/chatbot/buildPageContext';
...
export default function SelectCabin({ }: any) {
    ...
    const botPageContext = useMemo(() => buildCabinSelectPageContext({
        itineraryData,
        cabinData,
        isLoggedIn: !!token,
        onSelectCabin: handleChatbotCabinSelect,
    }), [itineraryData, cabinData, token, handleChatbotCabinSelect]);
