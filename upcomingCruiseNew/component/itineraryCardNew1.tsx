...
export default function ItineraryCardNew({
  type = 'upcoming',
  data,
  index,
  callback,
  ...
  const emiTotalAmount = data?.starting_fare;
  ...
  const BookNow = (itinerary_id: any) => {
    ...
    trackCustomEvent(ANALYTICS_EVENTS.BOOK_NOW_CLICKED, {
      ...
      no_of_nights: Number(data?.night_count),
      trip_type: data?.trip_type === 'round' ? 'Round Trip' : 'One Way Trip',
      price_starting_from: data?.starting_fare,
      trip_start_date: formatDateDDMMYYYY(data?.start_time),
      trip_end_date: formatDateDDMMYYYY(data?.end_time),
      offers_available:
        data?.offers_available
          ?.map((o: any) => (typeof o === 'object' ? o.offer : o))
          .join(', ') || '',
  ...
  const ViewItinerary = (itinerary_id: any) => {
    SaveStore({ itinerary: data });
    window.open(
      `/upcoming-cruises/itinerary?id=${itinerary_id}${
        type === 'reschedule' ? `&action=${type}` : ''
      }`,
      '_blank'
    );
  };
    ...
    <>
      <div className="grid grid-cols-10 mb-6 shadow-bottom lg:shadow-allSide rounded-lg overflow-hidden bg-white">
        <div className="col-span-10 lg:col-span-3 relative aspect-[1.58] lg:aspect-auto">
          <img
            className="h-full w-[90%] overflow-hidden rounded-md lg:rounded-none lg:rounded-l mx-auto lg:w-full"
            src={data?.image_url}
            alt=""
          />
            ...
            <div className="px-8 lg:px-4 py-4 flex flex-col justify-between items-start w-full h-full">
              ...
              <div
                ...
                style={{
                  ...
                  backgroundImage:
                    'linear-gradient(99.72deg, rgb(146 39 143 / 80%) -17.25%, rgb(234 114 91 / 80%) 105.93%)',
              ...
              >
                <img
                  className="h-3"
                  src="https://images.cordeliacruises.com/cordelia_v2/public/assets/cruise-itinerary-tag-white-icon.svg"
                  alt=""
                />
                <p className="text-[9px] font-semibold text-white uppercase">
                  {data?.ship_name}
                </p>
              </div>
            ...
            <div className="text-right absolute top-4 right-[5%] lg:right-0">
              <div className="bg-brand-green text-white inline-block rounded-l-full px-3 lg:px-4 py-1 lg:py-1.5">
                <div className="flex items-center gap-1">
                  <img
                    className="h-3"
                    src="https://images.cordeliacruises.com/cordelia_v2/public/assets/viewing-icon-white.svg"
                    alt=""
                  />
                  <p className="text-xxxs lg:text-xxs font-bold leading-none">
                    {views} Viewing
                  </p>
                </div>
              </div>
        ...
        <div className="col-span-10 lg:col-span-7 grid grid-cols-12 relative">
          <div className="lg:hidden col-span-12 lg:col-span-8 px-4 py-2 lg:py-6 flex justify-between items-center gap-3">
            <div className="flex flex-col gap-3">
              <p
                className={`text-[0.85rem] lg:text-[1.20rem] leading-6 font-bold lg:font-semibold basis-3/4`}
              >
              ...
              <div className="flex items-center gap-2">
                <div className="flex gap-1 items-center">
                  <p className="text-xs lg:text-[13px] text-gray-100">
                  ...
                  />
                  <p className="text-xs lg:text-[13px] text-gray-100">
                    {moment(data.end_time).format('MMM DD, YYYY')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div
            className={`col-span-12 lg:col-span-8 px-4 py-2 lg:py-6 relative ${
              Number(data?.night_count) > 20 && isExpanded
                ? 'lg:min-h-[360px]'
                : 'lg:min-h-[288px]'
            }`}
          >
            <div className="hidden lg:flex justify-between items-center gap-3">
              <div className="flex flex-col gap-2">
                <p
                  className={`hidden lg:block text-[0.85rem] lg:text-[1.20rem] leading-6 font-bold lg:font-semibold`}
                >
                  {data?.alias || itineraryName}
                </p>
            ...
            <div className="">
              <span className={`text-xs lg:text-xs font-bold !leading-5 mr-1`}>
                Ports:
              </span>
            ...
            <div className="hidden lg:block">
              {Array.isArray(data?.offers_available) ? (
                <div>
                  <p className="text-xxs lg:text-[11px] text-[#2274E0] font-semibold mb-2">
                    Available Offers
                  </p>
                        ...
                        if (typeof val === 'string') {
                          return (
                            <div className="flex items-center" key={i}>
                              <img
                                className="mr-2 h-4"
                                src="https://images.cordeliacruises.com/cordelia_v2/public/assets/offertag-upcoming-icon.svg"
                                alt=""
                              />
                              <p className="text-xs lg:text-xs font-semibold">
                                {val}
                              </p>
                            </div>
                          );
            ...
            <div className="col-span-12 mt-4 flex absolute bottom-0 left-0 w-full">
              ...
              >
                <img
                  src="https://images.cordeliacruises.com/cordelia_v2/public/assets/BPG-logo-icon.svg"
                  alt=""
                  className="w-4 h-4"
                />
          ...
          <div className="col-span-5 lg:hidden px-4">
            {Array.isArray(data?.offers_available) ? (
              <div>
                <p className="text-xxs lg:text-xs text-brand-blue font-bold mb-2">
                  Available Offers
                </p>
                    ...
                    return (
                      <div className="flex items-center mb-1" key={i}>
                        <img
                          ...
                          alt=""
                        />
                        <p className="text-xs lg:text-xs font-semibold text-brand-green">
                          {val}
                        </p>
                      </div>
                    );
          ...
          <div
            className={`col-span-7 lg:col-span-4 lg:border-l lg:py-3 border-gray-300 flex flex-col justify-center`}
          >
            <div
              className={`pl-0 pr-4 lg:px-3 text-right lg:text-center ${
                showRevealPriceCTA
                  ? 'mb-6 flex items-center justify-center flex-1'
                  : ''
              }`}
            >
              {!showRevealPriceCTA && (
                <div className="flex flex-col items-end lg:items-center gap-1">
                  {token && (
                    <>
                      <p className="text-xxs lg:text-xxs text-gray-100 font-normal">
                        Starting From
                      </p>
                      <div className="flex justify-center items-baseline gap-2">
                        {data?.discount_pct != 0 ? (
                          <span className="text-xs line-through text-gray-100">{`₹${FormatAmount(
                            data?.actual_starting_fare
                          )}`}</span>
                        ) : null}
                        <p
                          className={`text-sm lg:text-lg lg:leading-4 ${
                            showRevealPriceCTA ? 'font-bold' : 'font-medium'
                          }`}
                        >{`₹${FormatAmount(data?.starting_fare)}`}</p>
                      </div>
                      <p className="text-xxs lg:text-xxs mb-0 font-normal text-gray-100">
                        Excl. GST PP in Double Occupancy
                      </p>
                    </>
                  )}
                  {!showRevealPriceCTA && (
                    <div
                      ...
                      className="mt-1 p-2 rounded-md bg-gray-400/60 w-max cursor-pointer"
                    >
                      <p className="text-xxs lg:text-xs font-medium flex justify-center items-center lg:justify-start gap-1">
                      ...
                      <p className="inline-flex items-center gap-1 w-full justify-center text-base lg:text-2xl text-brand-primary font-bold whitespace-nowrap">
                        ₹{emiAmount}
                        <span className="text-xxs lg:text-xs font-normal text-gray-1100">
                          /month
                        </span>
              ...
              <div className="mt-3 hidden lg:block pb-2">
                <Button
                  ...
                  type="primary"
                  handleClick={() =>
                    showRevealPriceCTA ? callback() : BookNow(data.itinerary_id)
                  }
                />
                <Button
      ...
      {window.innerWidth < 768 ? (
        <BottomSheet
          isOpen={openFreeCancellation}
          setIsOpen={setOpenFreeCancellation}
        ...
        >
          <div className="py-4">
            <ul className="list-disc pl-4">
              <li className="text-xs text-gray-200 mb-1">
                This cancellation policy shall apply only upon receipt of full
            ...
            <Table
              ...
              data={[
                ...
                [
                  '45-31 Days',
                  '90% Refund on Cabin Fare + 100% Refund on Service Charges & Levies'
                ],
                [
                  '30-7 Days',
                  '80% Refund on Cabin Fare + 100% Refund on Service Charges & Levies'
                ],
