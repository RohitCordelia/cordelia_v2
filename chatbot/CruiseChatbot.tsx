...
import { AssistantResponse, ItinerarySummary, ItineraryDetail, AvailableCabin, CabinSelection, ExtractedFilters } from './types';
...
export default function CruiseChatbot({
    availablePorts,
    availableOrigins,
    availableDates,
    availableNights,
